...
from nl_token import RESERVED_IDENTIFIERS
from nl_log import log_error

from nl_util import is_digit
from nl_util import is_alpha
from nl_util import is_alpha_numeric
...
class Lexer:
    ...
    isn't a newline, it will increment and indentation level counter appropriately to 
