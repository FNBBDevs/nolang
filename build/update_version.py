...
with open("../nolang.py",  "r", encoding="utf8") as nolang_file:
    ...
    for idx, line in enumerate(lines):
        if line[:2] == "__":
            ...
            lines[idx] = line+"\n"
            break
with open("../nolang.py", "w", encoding="utf8") as nolang_file:
